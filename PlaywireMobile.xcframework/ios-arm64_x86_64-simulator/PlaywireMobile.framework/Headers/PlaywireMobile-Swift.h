...
#ifndef PLAYWIREMOBILE_SWIFT_H
#define PLAYWIREMOBILE_SWIFT_H
...
@interface PMAdsConfiguration : NSObject
...
SWIFT_CLASS("_TtC14PlaywireMobile10PMNotifier")
@interface PMNotifier : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) PMNotifier * _Nonnull shared;)
+ (PMNotifier * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
